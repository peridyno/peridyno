...
#pragma once
#include "HeightField/AdaptiveCapillaryWave.h"
...
namespace dyno 
{
	...
	class CWAaddBoatSpeed : public AdaptiveCapillaryWave<TDataType>
	{
		DECLARE_TCLASS(CWAaddBoatSpeed, TDataType)
	public:
	...
	private:
		std::shared_ptr<AdaptiveGridSet2D<TDataType>> mAGrid0 = nullptr;
	};
