...
namespace dyno 
{
	...
	class StaticBoundaryCircleInlet : public ComputeModule
	{
		DECLARE_TCLASS(StaticBoundaryCircleInlet, TDataType)
	public:
		typedef typename TDataType::Real Real;
		typedef typename TDataType::Coord Coord;

		StaticBoundaryCircleInlet() {};
		~StaticBoundaryCircleInlet() override {};
	...
	public:
		...
		DEF_VAR(Real, YPlane, 0.4, "");
		DEF_VAR(Real, XInlet1, -0.1, "");
		DEF_VAR(Real, XInlet2, 0.0, "");
		DEF_VAR(Real, XInlet3, 0.1, "");
	...
	DEFINE_CLASS(StaticBoundaryCircleInlet);
}
