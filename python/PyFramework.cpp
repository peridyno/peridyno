...
void pybind_framework(py::module& m)
{
	...
	py::class_<FBase, std::shared_ptr<FBase>>(m, "FBase")
		...
		.def("promote_output", &FBase::promoteOuput, py::return_value_policy::reference)
	...
	py::class_<VisualModule, Module, std::shared_ptr<VisualModule>>(m, "VisualModule")
		...
		.def("var_visible", &VisualModule::varVisible, py::return_value_policy::reference);
	...
	py::class_<Pipeline, Module, std::shared_ptr<Pipeline>>(m, "Pipeline")
		...
		.def("find_first_module_surface", static_cast<std::shared_ptr<dyno::GLSurfaceVisualModule>(Pipeline::*)()>(&Pipeline::findFirstModule))
		.def("find_first_module_point", static_cast<std::shared_ptr<dyno::GLPointVisualModule>(Pipeline::*)()>(&Pipeline::findFirstModule))
		.def("find_first_module_color_mapping", static_cast<std::shared_ptr<dyno::ColorMapping<dyno::DataType3f>>(Pipeline::*)()>(&Pipeline::findFirstModule))
