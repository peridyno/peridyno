...
void pybind_framework(py::module& m)
{
	...
	py::class_<dyno::Ramp, dyno::Canvas, std::shared_ptr<dyno::Ramp>>(m, "Ramp")
		...
		.def("add_item_my_coord", &dyno::Ramp::addItemMyCoord)
		...
		.def("rebuild_handle_point", &dyno::Ramp::rebuildHandlePoint)
		.def("calculate_length_for_point_set", &dyno::Ramp::calculateLengthForPointSet)
		.def("set_interp_mode", &dyno::Ramp::setInterpMode)
		...
		.def("build_segment_length_map", &dyno::Ramp::buildSegMent_Length_Map)
