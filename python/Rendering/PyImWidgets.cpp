...
void pybind_im_widgets(py::module& m)
{
	py::class_<dyno::ImChart>(m, "ImChart")
		.def(py::init())
		.def("setCoord", &dyno::ImChart::setCoord, py::return_value_policy::reference)
		.def("getCoord", &dyno::ImChart::getCoord, py::return_value_policy::reference)
		.def("inFrameNumber", &dyno::ImChart::inFrameNumber, py::return_value_policy::reference)
		.def("inValue", &dyno::ImChart::inValue, py::return_value_policy::reference)
		.def("inArray", &dyno::ImChart::inArray, py::return_value_policy::reference)
		.def("varMin", &dyno::ImChart::varMin, py::return_value_policy::reference)
		.def("varMax", &dyno::ImChart::varMax, py::return_value_policy::reference)
		.def("varFixHeight", &dyno::ImChart::varFixHeight, py::return_value_policy::reference)
		.def("varCount", &dyno::ImChart::varCount, py::return_value_policy::reference)
		.def("varTitle", &dyno::ImChart::varTitle, py::return_value_policy::reference)
		.def("varOutputFile", &dyno::ImChart::varOutputFile, py::return_value_policy::reference)
		.def("varOutputPath", &dyno::ImChart::varOutputPath, py::return_value_policy::reference)
		.def("varInputMode", &dyno::ImChart::varInputMode, py::return_value_policy::reference);
