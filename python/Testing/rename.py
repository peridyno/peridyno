...
# # 要重命名的文件路径
# file_to_rename = "E:\\Program\\Simulation\\Wt-test\\build\\bin\\Debug\\PyPeridyno-1.0.0d.cp312-win_amd64.pyd"
# # 重命名后的文件路径
...
# 要重命名的文件路径
file_to_rename = "H:\\program\\Simulation\\unibeam\\wt-test\\build\\bin\\Debug\\PyPeridyno-1.0.0d.cp312-win_amd64.pyd"
# 重命名后的文件路径
