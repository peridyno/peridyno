...
sampler1.state_point_set().promote_ouput().connect(initialParticles1.in_points())
...
sampler2.state_point_set().promote_ouput().connect(initialParticles2.in_points())
...
sampler3.state_point_set().promote_ouput().connect(initialParticles3.in_points())
...
sampler4.state_point_set().promote_ouput().connect(initialParticles4.in_points())
