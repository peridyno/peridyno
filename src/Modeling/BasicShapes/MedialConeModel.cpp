...
namespace dyno
{
	...
	template<typename TDataType>
	void MedialConeModel<TDataType>::pushback_medialslab(std::vector<Vec3f>& vertices, std::vector<Topology::Triangle>& triangles, Vec3f pA, Vec3f pB, Real rA, Real rB, uint resolution)
	{
