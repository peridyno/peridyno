#include "AdaptiveVolumeToTriangleSet.h"
...
namespace dyno
{
	...
	AdaptiveVolumeToTriangleSet<TDataType>::AdaptiveVolumeToTriangleSet()
		: TopologyMapping()
	{
	...
	template<typename TDataType>
	bool AdaptiveVolumeToTriangleSet<TDataType>::apply()
	{
