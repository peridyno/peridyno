...
//			printf("%f \n", max_lc);
	...
	template<typename TDataType>
	void UnifiedPositionConstraint<TDataType>::computeC(DeviceArray<Real>& c, DeviceArray<Coord>& pos, NeighborList<int>& neighbors)
	{
	...
	template<typename TDataType>
	void UnifiedPositionConstraint<TDataType>::computeLC(DeviceArray<Real>& lc, DeviceArray<Coord>& pos, NeighborList<int>& neighbors)
	{
