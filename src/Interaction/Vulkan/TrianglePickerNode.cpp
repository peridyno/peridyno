...
namespace dyno
{
		...
		:Node()
	{
		...
		surfaceRender1->varAlpha()->setValue(1.0f);
		...
		surfaceRender2->varAlpha()->setValue(1.0f);
	...
	void TrianglePickerNode<TDataType>::resetStates()
	{
		...
		this->surfaceInteractor->outOtherTriangleSet()->setDataPtr(std::make_shared<TriangleSet3f>());
		this->surfaceInteractor->outSelectedTriangleSet()->setDataPtr(std::make_shared<TriangleSet3f>());
		...
		this->edgeInteractor->outOtherEdgeSet()->setDataPtr(std::make_shared<EdgeSet3f>());
		this->edgeInteractor->outSelectedEdgeSet()->setDataPtr(std::make_shared<EdgeSet3f>());
		this->edgeInteractor->outOtherEdgeSet()->getDataPtr()->copyFrom(this->inTopology()->getData());

		this->pointInteractor->outOtherPointSet()->setDataPtr(std::make_shared<PointSet3f>());
		this->pointInteractor->outSelectedPointSet()->setDataPtr(std::make_shared<PointSet3f>());
