...
void TriangleRender::setVertexArray(DArray<float3>& vertArray)
{
...
void TriangleRender::setNormalArray(DArray<float3>& normArray)
{
...
void TriangleRender::setColorArray(DArray<float3>& colorArray)
{
