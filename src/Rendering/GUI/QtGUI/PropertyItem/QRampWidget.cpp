...
namespace dyno
{
	...
	void QDrawLabel::paintEvent(QPaintEvent* event)
	{
		...
		if (CoordArray.empty()) 
		{
			if (field->getValue().Originalcoord.empty())		//���field��û��Widget���ص����ݣ����field������Coord���г�ʼ��
			{
		...
		if (CoordArray.empty())			//�����closeģʽ����û�г�ʼ�����ݣ����ڿջ������������㣬��Ϊ�߽��
		{
			if (Mode == x)		//directionΪx��������߼�
			{
				if (generatorXmin)
				{
					MyCoord FirstCoord;
		...
		reSortCoordArray.assign(CoordArray.begin(), CoordArray.end());		//��CoordArrayΪreSortCoordArray��ֵ
		reSort(reSortCoordArray);		//��reSortCoordArray������
		...
		if (HandlePoints.empty())	//ͨ��CoordArray�������������Ʊ��ĵ�HandlePoints
		{
			buildHandlePointSet();
		}
