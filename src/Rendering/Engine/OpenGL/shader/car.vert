...
layout(location = 8) in float instance_headlight;	  
layout(location = 9) in float instance_brakeLight;	  
layout(location = 10) in float instance_turnSignal;	 
...
void main(void) {
	...
	if(uInstanced) {
		...
		vs.headlight = instance_headlight;
		vs.brakeLight = instance_brakeLight;
		vs.turnSignal = instance_turnSignal;
