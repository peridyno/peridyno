...
void main() {   
    if(uVertexNormal)
    {
        ...
        gs_out.headlight = gs_in[0].headlight;
        gs_out.brakeLight = gs_in[0].brakeLight;
        gs_out.turnSignal = gs_in[0].turnSignal;
        gs_out.localPosition = gs_in[0].localPosition;
        ...
        gs_out.headlight = gs_in[1].headlight;
        gs_out.brakeLight = gs_in[1].brakeLight;
        gs_out.turnSignal = gs_in[1].turnSignal;
        gs_out.localPosition = gs_in[1].localPosition;
        ...
        gs_out.headlight = gs_in[2].headlight;
        gs_out.brakeLight = gs_in[2].brakeLight;
        gs_out.turnSignal = gs_in[2].turnSignal;
        gs_out.localPosition = gs_in[2].localPosition;
