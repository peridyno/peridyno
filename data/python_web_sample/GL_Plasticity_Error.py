...
scene.add_node(topoMapper)
scene.add_node(surfaceVisualizer)
scene.add_node(elasticBody)
scene.add_node(surfaceMeshLoader2)
scene.add_node(boundary)
scene.add_node(topoMapper2)
scene.add_node(surfaceVisualizer2)